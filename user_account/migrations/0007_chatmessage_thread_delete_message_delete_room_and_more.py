# Generated by Django 4.2 on 2024-08-07 11:20
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('user_account', '0006_customuser_address_customuser_gender_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='thread',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='chatmessage_thread', to='user_account.thread'),
        ),
        migrations.AddField(
            model_name='chatmessage',
            name='user',
